package com.vinay.assignment_1;
...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        heartRateSubmit.setOnClickListener(v -> {
            ...
            File mediaFile = new File(Environment.getExternalStorageDirectory()+"/Android/data/com.vinay.assignment_1/files/fingerTip.mp4");
    ...
    protected void onActivityResult(int requestCode, int resultCode, @Nullable Intent data) {
        ...
        if(requestCode==VIDEO_RECORD_CODE){
            if(resultCode==RESULT_OK){
                ...
                Toast.makeText(getApplicationContext(),"Recording Cancelled Else",Toast.LENGTH_SHORT).show();
                System.out.println("Error Cancelled 1");
            }
        }
    }
    ...
    private class CalcHeartRateThread implements Runnable {
        ...
        @Override
        public void run() {
            String uri = Environment.getExternalStorageDirectory()+"/Android/data/com.vinay.assignment_1/files/fingerTip.mp4";
